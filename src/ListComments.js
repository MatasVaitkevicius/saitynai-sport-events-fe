...
function ListComments({ access_token }) {
    ...
    function createComment() {
        async function handleUpdate() {
            ...
            await fetch(`http://localhost:98/api/types/${typeId}/events/${eventId}/comments`, {
                method: "POST",
                headers: {
    ...
    function handleDelete(id) {
        async function deleteType() {
            setLoading(true);
            await fetch(`http://localhost:98/api/types/${typeId}/events/${eventId}/comments/${id}`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${access_token}`,
    ...
    async function fetchData() {
        console.log(typeId);
        setLoadingData(true);
        const repsonse = await fetch(`http://localhost:98/api/types/${typeId}/events/${eventId}/comments`, {
            method: "GET",
            headers: {
                Authorization: `Bearer ${access_token}`,
            },
    ...
    return (
        <>
            ...
            <div>
                <Box m={1} pt={1}>
                    <Button variant="contained" color="success" onClick={handleOpenCreate}>Create New Comment</Button>
                </Box>
                <Modal
                ...
                >
                    <Fade in={openCreate}>
                        <Box sx={style}>
                            ...
                            <Box m={2} pt={3}>
                                <Button onClick={createComment} color="secondary" variant="contained">
